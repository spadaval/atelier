...
fn test_evidence_capture_records_command_metadata_and_attaches_targets() {
    ...
    let issue_evidence_front_matter = canonical_evidence_front_matter(dir.path(), &issue_evidence_id);
    assert_eq!(
    ...
    assert_eq!(positional_evidence_front_matter["evidence_type"], "validation");
    assert_eq!(
