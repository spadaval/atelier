...
Validate that the strong-proof guidance is operational by applying it to representative ordinary issue, CLI behavior, parent closeout, and validation-item examples.
