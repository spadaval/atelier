...
schema_version: 1
closed_at: '2026-06-11T18:59:55.061237338+00:00'
status: closed
...
- Manual check: Linked epics prove issue lifecycle, issue relationships, first-class records, projection refresh, compatibility removal, and closeout validation for fresh checkout rebuild, mutation recoverability, stale projection repair, invalid Markdown failure, lint, doctor, export freshness, and full Rust test coverage.

## Notes

Migrated from `.atelier/missions/atelier-2nc9.md` as a declared mission objective issue.
