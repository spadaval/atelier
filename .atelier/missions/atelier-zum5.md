...
- Known-ID issue mutations become Markdown-first writes followed by projection refresh or stale marking.
- Projection freshness detects changed, missing, or unindexed canonical sources before query commands answer.
- RuntimeState health is reported separately from canonical projection rebuild readiness.
