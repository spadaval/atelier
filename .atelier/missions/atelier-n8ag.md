...
- Linked work proves lightweight and strict workflows, validator-backed transitions, waivers, action-aware guidance, mission status CLI, evidence gaps, blocker visibility, active mission focus, Agent Factory guidance, branch/worktree ergonomics, artifact readiness, and closeout proof.
