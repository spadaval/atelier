...
- CLI help and representative commands no longer advertise or accept command-result --json mode, except for explicitly approved non-result diagnostic surfaces.
- Human output fixtures prove selected commands expose enough actionable context without unbounded field dumps.
- Docs and Agent Factory guidance no longer describe JSON result output as Atelier's automation contract.
