---
created_at: "2026-07-09T16:40:21.227345168+00:00"
id: "atelier-9z09"
evidence_type: "test"
captured_at: "2026-07-09T16:40:19.463301273+00:00"
command: "bash -lc 'atelier work ready | tee /tmp/atelier-2uim-rerun-open.txt; ! rg \"atelier-(amfw|wyxn|l5mw)\" /tmp/atelier-2uim-rerun-open.txt; for id in atelier-amfw atelier-wyxn atelier-l5mw; do test \"$(atelier issue show \"$id\" | sed -n '\"'\"'/Blocked by/,/Blocking/p'\"'\"' | rg -c '\"'\"'atelier-(2uim|wlk4)'\"'\"')\" -eq 2; done'"
exit_status: "0"
...
schema_version: 1
status: "recorded"
title: "bash -lc 'atelier work ready | tee /tmp/atelier-2uim-rerun-open.txt; ! rg \"atelier-(amfw|wyxn|l5mw)\" /tmp/atelier-2uim-rerun-open.txt; for id in atelier-amfw atelier-wyxn atelier-l5mw; do test \"$(atelier issue show \"$id\" | sed -n '\"'\"'/Blocked by/,/Blocking/p'\"'\"' | rg -c '\"'\"'atelier-(2uim|wlk4)'\"'\"')\" -eq 2; done'"
updated_at: "2026-07-09T16:40:26.059668905+00:00"
---

## Summary

bash -lc 'atelier work ready | tee /tmp/atelier-2uim-rerun-open.txt; ! rg "atelier-(amfw|wyxn|l5mw)" /tmp/atelier-2uim-rerun-open.txt; for id in atelier-amfw atelier-wyxn atelier-l5mw; do test "$(atelier issue show "$id" | sed -n '"'"'/Blocked by/,/Blocking/p'"'"' | rg -c '"'"'atelier-(2uim|wlk4)'"'"')" -eq 2; done'
