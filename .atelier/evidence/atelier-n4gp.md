...
```console
bash -lc 'rg -n "workflow check|diagnostics slow|import-beads|atelier rebuild|atelier export|maintenance delete|branch status|worktree repair|worktree for-mission" docs AGENTFACTORY.md /root/.agents/skills/agent-factory .atelier/issues/atelier-1xmi.md'
```
