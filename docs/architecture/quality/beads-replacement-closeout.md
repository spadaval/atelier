...
| Docs no longer instruct normal agents to use the predecessor CLI for `/root/atelier`. | pass | `AGENTS.md` prohibits the predecessor CLI for planning, execution, handoff, and recovery; `AGENTFACTORY.md` names Atelier commands. |
