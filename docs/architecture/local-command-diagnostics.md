...
| `command` | string | Top-level command path such as `issue show`, `check`, or an advanced diagnostic command. |
...
`atelier check`, `atelier check`, `check --fix`, and any advanced export or
