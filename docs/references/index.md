...
- `factory-missions.md`: Factory Missions reference notes.
- `minibeads.md`: Minibeads reference notes.
- `symphony.md`: Symphony reference notes.
- `worktrunk.md`: Worktrunk reference notes.
