...
| `issue update` | Manager/orchestrator | Correct issue metadata, parent, labels, type, priority. | Good. Claim is not part of issue update; active local work belongs to `atelier start` and status-derived workflow surfaces. |
