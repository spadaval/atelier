...
- Replacement: Use `atelier status`, `atelier mission status`,
...
| --- | --- | --- |
| `worktree for-mission <id>` | Manager/orchestrator | Deferred. Use normal checkout plus `mission status` until workspace management is redesigned. |
