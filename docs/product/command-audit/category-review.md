...
| `workflow check` | Hide/admin-frame | Keep as raw workflow-policy debugging. Normal readiness uses `issue transition`, `issue status <objective-id>`, and `lint`. | No new issue. |
