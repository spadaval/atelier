...
Acceptance: human mission list sorts non-closed missions before closed missions by updated time descending; rows include updated date, work counts, blockers, and evidence state; empty filtered output includes next-command guidance; JSON mission list remains `{ data: [...] }`.
